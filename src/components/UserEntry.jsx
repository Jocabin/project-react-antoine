export default function UserEntry({ user, selectUser, current }) {
  return (
    <>
      <li>
        <button
          onClick={selectUser}
          className={`p-4 w-full text-left flex flex-row justify-between items-center border-b border-border/40 bg-background hover:bg-slate-100 ${
            user.node_id === current?.node_id
        ...
        >
          <div className="flex flex-row items-center justify-center gap-4">
            <img
              className="rounded-lg overflow-hidden w-10"
              src={user.avatar_url}
              alt="avatar"
            />
